...
class University:
    def __init__(self, root):
        ...
        self.btnCourseDetails.grid(row=0, column=0)
        ...
        self.btnLogin_Page.grid(row=2, column=0)
    ...
    def iExit(self):
        iExit = tkinter.messagebox.askyesno("University Management System", "Confirm if you want to exit")
        if iExit > 0:
            root.destroy()
            return
